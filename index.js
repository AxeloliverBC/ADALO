...
function updatePages() {
    pages.forEach((page, index) => {
        ...
        if (!page.classList.contains('cover') && !page.classList.contains('thanks-page')) {
            const colorIndex = (index - 1) % pageColors.length;
    ...
    homeBtn.style.display = currentPage === 0 ? 'none' : 'block';
}

function playPageFlipSound() {
    if (pageFlipSound.readyState >= 2) {
